...
#define SERIAL_DEFAULT_CFG                                                                                                       \
    (SerialCfg_s)                                                                                                                \
    {                                                                                                                            \
        .baudrate = 115200U, .dataBits = DATA_BITS_8, .stopBits = STOP_BITS_1, .parity = PARITY_NONE,                            \
        .flowCtrl = FLOW_CTRL_NONE, .overSampling = OVERSAMPLING_16, .txBufSize = SERIAL_MIN_TX_BUFSZ,                           \
