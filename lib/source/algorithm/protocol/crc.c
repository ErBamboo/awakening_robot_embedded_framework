...
/*
** Descriptions: CRC8校验和函数
** Input: 要检查的数据、流长度、初始化的校验和
** Output: CRC 校验和
*/
...
/*
** Descriptions: CRC8验证函数
** Input: 要验证的数据，流长度=数据+校验和
** Output: 真假(CRC验证结果)
*/
...
/*
** Descriptions: 将CRC8附加到数据的末尾
** Input: 需要追加CRC8的数据，流长度=数据+校验和
** Output: 真假(CRC验证结果)
*/
...
/*
** Descriptions: 将CRC16附加到数据的末尾
** Input: 需要追加CRC16的数据，流长度=数据+校验和
** Output: 真假(CRC验证结果)
*/
